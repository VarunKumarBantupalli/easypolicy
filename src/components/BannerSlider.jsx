...
const BannerSlider = () => {
  ...
  }, [currentBanner]); // Restart interval when currentBanner changes
  ...
  return (
    <div
      className="relative w-3/4 mx-auto mt-6"
    ...
    >
      ...
      >
        ...
        <a href="#below">
          <button className="bg-blue-600 text-white px-4 py-2 mt-3 rounded-md hover:bg-blue-700 transition-all duration-300">
            View Plans
          </button>
        </a>
      </div>
